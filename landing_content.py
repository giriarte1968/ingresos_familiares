...
def get_hero_html(stats: dict) -> str:
    ...
    return (
        ...
        f'<p class="hero-sub">Valuación por Comparables basada en más de <b>9,000</b> propiedades reales del mercado. El estándar de datos para el mercado inmobiliario local.</p>'
