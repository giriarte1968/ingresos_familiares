...
def render_disk_summary_card(prop, insuficientes=False, v_cons=0, v_opt=0, spread=0, auto_result=None):
    ...
    if auto_result and auto_result.get('valor_propiedad_usd', 0) > 0:
        ...
        comps = len(comps_list) if comps_list is not None else auto_result.get('n_comps', 0)
        m2_equiv = prop.get('m2_equivalentes') or prop.get('m2_cubiertos') or auto_result.get('m2_equivalentes', 0)
        m2_micro = auto_result.get('m2_microzona', 0) or auto_result.get('m2_base_venta', 0)
