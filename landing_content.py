...
def get_features_html() -> str:
    features = [
        ...
        ("Datos de Infomapa Rosario",
         ...
         '<img src="https://images.unsplash.com/photo-SpMJcbOq5i4?w=100&q=60&fm=webp" alt="" class="feature-icon-img" />'),
        ...
        ("Transparencia total",
         ...
         '<img src="https://images.unsplash.com/photo-1hSh1aDG6Mg?w=100&q=60&fm=webp" alt="" class="feature-icon-img" />'),
        ("Informe profesional",
