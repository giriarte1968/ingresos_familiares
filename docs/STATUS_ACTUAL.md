...
*Actualizado: 30/06/2026 (TAREA-094: Sincronización header con exclusión de comparables)*
...
| Tests regresión | ✅ 51/51 (incluye TAREA-094 test_header_sync_on_exclusion) |
...
| Archivo | Estado |
|---------|--------|
| `tests/test_regression.py` | 51/51 ✅ |
