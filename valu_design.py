...
def hero_price(valor_usd, valor_ars, dolar, m2_base, n_comps, zona, m2_puro=None, barrier_pct=0, fuente_label="VALUACION POR COMPARABLES"):
    ...
    <div style="background:linear-gradient(135deg,#006AFF 0%,#004FC4 100%);border-radius:16px;padding:28px;color:white;font-family:'Inter',sans-serif;">
        <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;opacity:0.8;margin-bottom:8px;">{fuente_label}</div>
...
<style>
    ...
    .final-cta {
        background:
            radial-gradient(circle at 50% 30%, rgba(16, 185, 129, 0.35), transparent 50%),
